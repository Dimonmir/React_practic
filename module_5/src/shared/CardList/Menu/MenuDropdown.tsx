...
const close = styles.menuItem + ' ' + styles.close;
const table = styles.menuItem + ' ' + styles.tableActiv;
const tableDivider = styles.divider + ' ' + styles.tableActiv;
  ...
  return (
      <div className={styles.menuItemsList}>
          ...
          <div className={styles.menuItem}>
              ...
              <div className={close}>
                  <svg width="16" height="14" viewBox="0 0 16 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M0 14H16L8 0L0 14ZM8.72727 11.7895H7.27273V10.3158H8.72727V11.7895ZM8.72727 8.8421H7.27273V5.89474H8.72727V8.8421Z" fill="#D9D9D9"/>
                  </svg>
